...
class nagios::params {
    ...
    'debian' : {
      ...
      $srv_package     = 'nagios3'
      $plugin_packages = [ 'nagios-plugins', 'nagios-snmp-plugins', 'nagios-nrpe-plugin']
    }
    'Ubuntu' : {
      $nagios_cfg_dir  = '/etc/nagios3'
      $nagios_service  = 'nagios3'
      ...
      $web_dir         = '/usr/share/nagios3/htdocs/'
      $srv_package     = 'nagios3'
      $plugin_packages = [ 'nagios-plugins', 'nagios-plugins-extra', 'nagios-nrpe-plugin']
    }
    'SLES' : {
      ...
      $web_dir         = '/usr/share/nagios3/htdocs/'
      $srv_package     = 'nagios'
      $plugin_packages = [ 'nagios-plugins', 'nagios-plugins-extras', 'nagios-plugins-nrpe' ]
    }
    'centos' : {
      $nagios_cfg_dir  = '/etc/nagios'
      $nagios_service  = 'nagios'
      ...
      $web_dir         = '/usr/share/nagios3/htdocs/'
      $srv_package     = 'nagios'
      $plugin_packages = [ 'nagios-plugins', 'nagios-plugins-smtp','nagios-plugins-http',
